...
const Footer = () => {
  return (
    <div className='flex flex-col align-center gap-4 px-32 py-8 w-auto h-[494px] absolute'>
        <div className='flex flex-row'>
                <p className="border border-[#EFF1F1] w-[1152px] h-0"></p>
        </div>
        <div className='flex flex-row justify-between align-start gap-12 pt-8'>
            ...
            <div className='flex flex-row align-start gap-12 w-[448px] h-[270px]'>
